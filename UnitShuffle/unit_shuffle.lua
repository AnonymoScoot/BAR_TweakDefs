...
for _, builder in pairs(builders) do
    if UnitDefs[builder] then
        ...
        if builder_copy.buildoptions then
            if #builder_copy.buildoptions > 0 then
                for index, _ in pairs(builder_copy.buildoptions) do
                    builder_copy.buildoptions[index] = all_units[math.random(#all_units)]
                end
            end
        end
